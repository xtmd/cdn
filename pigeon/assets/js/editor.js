...
$(function() {
    if($('#wmd-button-row').length>0){
        ...
        $('#wmd-button-row').append('<li class="wmd-button" id="wmd-text-button" style="" title="插入高亮文本">' +'<svg class="icon" aria-hidden="true"><use xlink:href="#icon-tanhao"></use></svg>' +'</li>');
        ...
        $('#wmd-button-row').append('<li class="wmd-button" id="wmd-anniu-button" style="" title="插入按钮">' +'<svg class="icon" aria-hidden="true"><use xlink:href="#icon-anniu"></use></svg>' +'</li>');
        ...
        $('#wmd-button-row').append('<li class="wmd-button" id="wmd-blackcard-button" style="" title="插入经过可见">' +'<svg class="icon" aria-hidden="true"><use xlink:href="#icon-shubiao"></use></svg>' +'</li>');
        ...
        $(document).on('click', '#wmd-anniu-button', function() {
            ...
            $('body').append(
                ...
                '<div>'+
                '<p><b>插入按钮</b></p>'+
                '<p><labe>按钮颜色</labe><input name="color"' +
                ' type="text" placeholder="选填（如 #ffffff 、red）"></input></p>' +
